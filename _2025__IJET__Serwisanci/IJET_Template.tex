...
\hypersetup
{pdfauthor={Adam Babacki, John Cabacki, Chris Doe},%
pdftitle={Example of Article for International Journals of Electronics and Telecommunications},%
...
\title{\vspace{1cm} Example of Article for International Journals of Electronics and Telecommunications} %title suggested by the Professor, however, it's up to us to change it according to our topics.
%
%
...
\thispagestyle{fancy}\markboth{A.~Babacki, J.~Cabacki, C.~Doe}{Example of Article for International Journals of Electronics and Telecommunications}
%
