...
\pdfinfo {
	/Author (Radosław Idzikowski, Michał Jaroszczuk, Konrad Pempera)
	/Title (Time- and Skill-dependent Vehicle Routing Problem in application of facility maintenance)
	/Keywords (IEEEtran; journal; LaTeX; paper; template)
}

\hypersetup
{pdfauthor={Radosław Idzikowski, Michał Jaroszczuk, Konrad Pempera},%
pdftitle={Time- and Skill-dependent Vehicle Routing Problem in application of facility maintenance},%
pdfsubject={International Journal of Electronics and Telecommunications, 4 (2022), 300-306. DOI: 10.24425/ijet.2022.139xxx},%
pdfkeywords={IEEEtran; journal; LaTeX; paper; template},%
pdfproducer={LaTeX},%
pdfcreator={pdfLaTeX}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\title{\vspace{1cm} Time- and Skill-dependent Vehicle Routing Problem in application of facility maintenance} %title suggested by the Professor, however, it's up to us to change it according to our topics.
%
%
...
\author{Radosław~Idzikowski, Micha\l{}~Jaroszczuk and Konrad Pempera % <-this % stops a space
	\thanks{Rados\l{}aw~Idzikowski is with Department of Control and Quantum Computing, Wrocław University of Science and Technology, Wybrzeże Wyspiańskiego 27, 50-370 Wrocław, Poland (e-mail: radoslaw.idzikowski@pwr.edu.pl, ORCiD: 0000-0001-5232-1998).}% <-this % stops a space
	\thanks{Michał~Jaroszczuk is with Department of Control and Quantum Computing, Wrocław University of Science and Technology, Wybrzeże Wyspiańskiego 27, 50-370 Wrocław, Poland (e-mail: michal.jaroszczuk@pwr.edu.pl, ORCiD: 0009-0009-8617-889X).}% <-this % stops a space    
    \thanks{Konrad~Pempera is with Department of Control and Quantum Computing, Wrocław University of Science and Technology, Wybrzeże Wyspiańskiego 27, 50-370 Wrocław, Poland (e-mail: konrad.pempera@pwr.edu.pl,\linebreak{}ORCiD:~0009-0002-0701-9639).}% <-this % stops a space
}
	%\thanks{X, Y and Z are with Faculty of Electrical Engineering and Communication,  University of Technology, city, country (e-mail: {X, Y, Z}@xxx.yyy.abc).}% <-this % stops a space
...
\maketitle
\thispagestyle{fancy}%
\markboth{[blind version]}{Example of Article for International Journals of Electronics and Telecommunications}
%
...
\begin{abstract}
With current technological advancements, almost all new buildings require periodic maintenance inspections of their installed facilities. These inspections are performed by technicians with varying experience, and therefore varying work hours and rates. However, such inspections often cannot be performed while the building is in use, necessitating scheduling visits based on available time windows. In this paper, the described vehicle routing problem with time windows and varying employee rates is formulated using the MILP model. Four solution methods are proposed: a mathematical solver, an adapted Tabu Search algorithm, adapted 1nn algorithm, and the Artificial Bee Colony Algorithm. The aim of the study is to examine the impact of time window lengths and the junior-senior ratio of technician groups to the final solution. The results show that...
\end{abstract}
...
\begin{IEEEkeywords}
Skill-dependent VRP, Building maintenance, Tabu Search, Gurobi, MILP
\end{IEEEkeywords}
